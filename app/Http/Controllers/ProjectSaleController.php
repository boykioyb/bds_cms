...
{
    const TITLE = 'dự án';
    const URL_HOME = 'project-sales';
    const  VIEW = 'project_sale';
    private $repository;
    private $investor;
    private $city;

    public function __construct(ProjectSaleRepository $repository, InvestorRepository $investor, CityRepository $city)
    {
