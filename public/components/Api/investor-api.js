        ...
        a = $("#m_table_1").DataTable({
            ...
            columnDefs: [{
                targets: -1, title: "Thao tác", orderable: !1, render: function (a, e, t, n) {
                    let action = '<a href="/investors/edit/' + t._id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="sửa">';
