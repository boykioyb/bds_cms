        ...
        a = $("#m_table_1").DataTable({
            ...
            columnDefs: [{
                ...
                targets: 1, render: function (a, e, t, n) {
                    return void 0 === a ? a : '<a href="' + t.url_alias + '"><span class="m-badge m-badge--primary m-badge--rounded">' + a + "</span></a>"
                }
            }, {
                targets: 2, render: function (a, e, t, n) {
                    let html = '<p>' + (t.city !== null ? t.city : 'Đang cập nhật') + '/ ' + (t.district !== null ? t.district : 'Đang cập nhật') + '</p>';
                    return html;
                }
            }, {
                targets: 3, render: function (a, e, t, n) {
                    let html = '<div>';
                    html += '<p>Loại hình phát triển: ' + (t.type !== '' ? t.type : 'Đang cập nhật') + '</p>';
                    html += '<p>Quy mô dự án: ' + (t.scale !== '' ? t.scale : 'Đang cập nhật') + '</p>';
                    html += '<p>Phân khúc chức năng: ' + (t.functional !== '' ? t.functional : 'Đang cập nhật') + '</p>';
                    html += '<p>Tư vấn thiết kế: ' + (t.design_consultancy !== '' ? t.design_consultancy : 'Đang cập nhật') + '</p>';
                    html += '<p>Tư vấn quản lý và giám sát dự án: ' + (t.pm_mc !== '' ? t.pm_mc : 'Đang cập nhật') + '</p>';
                    html += '<p>Diện tích đất nghiên cứu: ' + (t.land_area_of_study !== '' ? t.land_area_of_study + ' m<sup>2</sup>' : 'Đang cập nhật') + '</p>';
                    html += '<p>Diện tích đất xây dựng: ' + (t.construction_land_area !== '' ? t.construction_land_area + ' m<sup>2</sup>' : 'Đang cập nhật') + '</p>';
                    html += '<p>Mật độ xây dựng: ' + (t.construction_density !== '' ? t.construction_density + ' %' : 'Đang cập nhật') + '</p>';
                    html += '</div>';
                    return html;
                }
            }, {
                targets: 4, render(a, e, t, n) {
                    var s = {
                        0: 'Không ưu tiên',
                        1: 'Ưu tiên cấp 1',
                        2: 'Ưu tiên cấp 2',
